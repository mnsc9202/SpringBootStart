package mnsc.start.jpaConfig.board.controller;
...
import mnsc.start.jpaConfig.board.domain.dto.BoardSaveReqDto;
import mnsc.start.jpaConfig.board.domain.dto.BoardUpdateReqDto;
import mnsc.start.jpaConfig.board.service.BoardService;
